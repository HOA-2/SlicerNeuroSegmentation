...
class SegmentEditorNeuroSegmentEffects(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "SegmentEditorNeuroSegmentEffects"
        self.parent.categories = ["Segmentation"]
        self.parent.dependencies = ["Segmentations"]
        self.parent.contributors = ["Kyle Sunderland (PerkLab)"]
    ...
    def registerEditorEffect(self):
        ...
        moveInstance = qSlicerSegmentationsEditorEffects.qSlicerSegmentEditorScriptedEffect(None)
        moveEffectFilename = os.path.join(os.path.dirname(__file__), self.__class__.__name__ + 'Lib/MoveSegmentEditorEffect.py')
        moveInstance.setPythonSource(moveEffectFilename.replace('\\', '/'))
        moveInstance.self().register()


class SegmentEditorNeuroSegmentEffectsTest(ScriptedLoadableModuleTest):
    """
    ...
    def runTest(self):
        ...
        """
        self.setUp()
        self.test_NeuroSegmentEffects1()

    def test_NeuroSegmentEffects1(self):
        """
        ...
        The test can be executed from SelfTests module (test name: SegmentEditorNeuroSegmentEffects)
        """

        self.delayDisplay("Starting test_NeuroSegmentEffects1")
        ...
        segmentEditorWidget.setActiveEffectByName("NeuroSegmentEffects")
        ...
        self.delayDisplay('test_NeuroSegmentEffects1 passed')
